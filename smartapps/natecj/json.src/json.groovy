 ...
 *  JSON
 *
 *  Copyright 2016 Nathan Jacobson
 *
...
definition(
  ...
  description: "A JSON Api for SmartThings Devices",
...
def copyConfig() {
  ...
  dynamicPage(name: "copyConfig", title: "Config", install:true) {
    ...
    section() {
      href url:"https://graph.api.smartthings.com/api/smartapps/installations/${app.id}/devices?access_token=${state.accessToken}", style:"embedded", required:false, title:"Debug", description:"View devices JSON"
    }
  }
}
